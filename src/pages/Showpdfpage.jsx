...
const downloadPDF = (url) => {
  axiosInstance.post(`${ipaddress}/DownloadDocument/`,{
...
<button data-bs-toggle="modal" data-bs-target="#postmodal" className="btn d-flex align-items-center gap-2 py-2 justify-content-center px-3" style={{border:'1px solid #fff',color:'#fff',fontSize:'14px',lineHeight:'normal',letterSpacing:'0.28px'}}>Create Post</button>
 ...
 <span className="text-white ms-3 d-flex align-items-center" style={{fontSize:'14px'}}>
  <img src={pdfurldata && pdfurldata.user_id && pdfurldata.user_id.profile_pic && pdfurldata.user_id.profile_pic} className={`me-2 my-auto ${pdfurldata.user_id.profile_pic !=null ? 'rounded-circle':'d-none'}`} width={30} height={30} alt="" />
...
{fetchedreplies_for_reply && fetchedreplies_for_reply.length > 0 && ( 
 ...
 <div className='col-12 bg-white px-3 pt-2'>
  ...
  <path d="M5 23.125V6.875L24.2789 15L5 23.125ZM6.25 21.25L21.0625 15L6.25 8.75V13.6058L12.3077 15L6.25 16.3942V21.25Z" fill="#8E9696"/>
           ...
           <p style={{color:'#ff845d',fontSize:'13px',fontStyle:'italic'}}>*You can edit your post within 24 hours after posting</p>
...
<div className="px-4">
<div className={`button-container rounded d-flex justify-content-center align-items-center border border-bottom-0 py-1 ${isSticky ? 'sticky2':''}`} style={{backgroundColor:'#5d5fe3'}}>
...
{/* -------------------------------------------TRANSLATE DOCUMENT TOAST MESSAGE---------------------------------------- */}
 ...
 <div className='bg-white px-3 pt-2 pb-3'>
  ...
  <div className="modal fade" id="sharedocumentlinkmodal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
   <div className="modal-dialog modal-dialog-centered modal-lg">
     <div className="modal-content">
       <div className="modal-body">
